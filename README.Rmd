...
The package contains two data sets, namely `tracer` and `drainage`. Both originate from the publication by @Bogner2019 (there called column C1, irrigation intensity 10 mm h$$x^{-1}$$).
